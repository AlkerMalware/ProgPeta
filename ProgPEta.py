...
# this below here defire the character you play as, ok, :)
...
#define boss, fight boss kill or die boss, :|
...
# function to choose your class(pick luck make it difficult)
def choose_class():
...
# function for inventory(this could have just become the healing option instead of inventory)
...
# function on how the battle goes, its just random subtraction
...
# what keep the world of greifa round and round, its a loop until you break it
def game_loop():
    while True:
        ...
        if start_game == "N":
            ...
            if player_hp > 0:
                print("\nCongratulations! You have conquered your own Trial!")
